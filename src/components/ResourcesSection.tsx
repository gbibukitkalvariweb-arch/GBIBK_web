...
const ResourcesSection = () => {
  ...
  return (
    <section id="resources" className="section-padding max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        ...
        <div className="relative max-w-xs w-full">
          ...
          <input
            ...
            className="w-full bg-surface border border-border rounded-lg pl-10 pr-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {filtered.map((item, i) => (
          <motion.div
            ...
            className="bg-surface rounded-xl overflow-hidden border border-border hover:border-primary/30 transition-colors group cursor-pointer"
          >
            <img
              src={item.img}
              alt={item.title}
