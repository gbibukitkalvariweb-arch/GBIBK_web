      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 text-sm text-background/60">
            <a href="mailto:info@gbibukitkalvari.id" className="inline-flex items-center gap-2 hover:text-background transition-colors">
              <Mail className="w-4 h-4" /> info@gbibukitkalvari.id
            </a>
            <a href="https://wa.me/6281234567890" className="inline-flex items-center gap-2 hover:text-background transition-colors">
        ...
        <div>
          ...
          <div className="flex gap-4 mb-6">
            <a href="#" className="w-10 h-10 rounded-lg bg-background/10 flex items-center justify-center text-background/60 hover:text-primary hover:bg-primary/10 transition-colors">
